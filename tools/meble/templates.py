...
def _carcass(cab_id, name, category, width, height, depth, material, edgeband,
    ...
    panels = [
        {"id": "bok-l", "name": "Bok lewy", "element_type": "panel", "role": "side-left",
         "width": depth, "height": height, "edge_banding": _band(2, edgeband)},
        {"id": "bok-r", "name": "Bok prawy", "element_type": "panel", "role": "side-right",
         "width": depth, "height": height, "edge_banding": _band(2, edgeband)},
        {"id": "wieniec-dolny", "name": "Wieniec dolny", "element_type": "panel", "role": "bottom",
         "width": inner_w, "height": depth, "edge_banding": _band(1, edgeband)},
        {"id": "wieniec-gorny", "name": "Wieniec górny", "element_type": "panel", "role": "top",
         "width": inner_w, "height": depth, "edge_banding": _band(1, edgeband)},
    ]
    if with_shelf:
        panels.append({"id": "polka", "name": "Półka", "element_type": "panel", "role": "shelf",
                       "width": inner_w, "height": depth - 20, "edge_banding": _band(1, edgeband),
                       "holes": []})
    panels.append({"id": "plecy", "name": "Plecy HDF", "element_type": "panel", "role": "back",
                   "material": "hdf-3", "width": width, "height": height, "grain": "any",
                   "edge_banding": {}})

    fittings = [
        {"id": "cf-bot-l", "hardware": "confirmat-7x50", "through": "bok-l", "into": "wieniec-dolny",
         "seam": {"through_edge": 3, "into_edge": 4}, "at": at},
        {"id": "cf-bot-r", "hardware": "confirmat-7x50", "through": "bok-r", "into": "wieniec-dolny",
         "seam": {"through_edge": 3, "into_edge": 2}, "at": at},
        {"id": "cf-top-l", "hardware": "confirmat-7x50", "through": "bok-l", "into": "wieniec-gorny",
         "seam": {"through_edge": 1, "into_edge": 4}, "at": at},
        {"id": "cf-top-r", "hardware": "confirmat-7x50", "through": "bok-r", "into": "wieniec-gorny",
...
def scaffold(kind: str, width: float, height: float, depth: float,
    ...
    name = name or f"Szafka {kind} {int(width)}"
